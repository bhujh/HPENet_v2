...
def write_img(points, colors, labels, out_filename):
    ...
    # ax.axis("off")
    ax.set_title(f"{out_filename.split('/')[-1].split('-')[0]}")
    ax.set_aspect("equal")
