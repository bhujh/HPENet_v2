...
int main(int argc, char** argv) {
    ...
    const char* data_dir = get_arg(argc, argv, "--data_dir", "D:/ProgramData/hpenet_onnx/radarfull/raw");
    const char* output_dir = get_arg(argc, argv, "--output_dir", "D:/ProgramData/hpenet_onnx/radarfull/output");
    const char* onnx_path  = get_arg(argc, argv, "--onnx", "D:/ProgramData/hpenet_onnx/onnx_model.onnx");
    const char* stats_file = get_arg(argc, argv, "--stats_file", "D:/ProgramData/hpenet_onnx/stats.json");
