// ============================================================================
// HPENet V2 — InferencePipeline: 完整推理流水线
//
// 组装所有模块：
//   PLY → voxelize → preprocess → TRT inference → scatter_mean → argmax
//
// 功能等价于 Python deploy/trt_inference.py:infer_one_cloud_trt() + main 循环。
// ============================================================================
#pragma once
